...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { comentario: @comentario.comentario, depactual: @comentario.depactual, depanterior: @comentario.depanterior, fecha: @comentario.fecha, pqr_id: @comentario.pqr_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { comentario: @comentario.comentario, depactual: @comentario.depactual, depanterior: @comentario.depanterior, fecha: @comentario.fecha, pqr_id: @comentario.pqr_id } }
